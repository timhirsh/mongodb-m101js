...
// After you have completed that task, please download final3.zip from the
// Download Handout link and run final3-validate.js to get the validation code
// and put it in the box below without any extra spaces. The validation script
// assumes that it is connecting to a simple mongo instance on the standard port
// on localhost.
